...
def load_data(datafile, num_clss, save=False, save_path='dataset.pkl'):
    ...
    for line in train_list:
        fpath = 'AgriculturalDisease_trainingset\\images\\'+line['image_id']
        print(fpath)
...
def train(network, X, Y):
    ...
    model.fit(X, Y, n_epoch=1000, validation_set=0.1, shuffle=True,
              ...
              snapshot_epoch=False, run_id='alexnet_61')
...
if __name__ == '__main__':
    X, Y = load_data('AgriculturalDisease_train_annotations.json', 61, True)
